        ...
        firestore.collection("QuizQuestions")
                                ...
                                button.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        if (selectedOption.equals(correctOption)) {
                                            Toast.makeText(firstqActivity.this, "Correct", Toast.LENGTH_LONG).show();
                                        } else {
                                            Toast.makeText(firstqActivity.this, "Incorrect", Toast.LENGTH_LONG).show();
                                        }
                                        // Display explanation
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(firstqActivity.this, "Failed to fetch question", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
